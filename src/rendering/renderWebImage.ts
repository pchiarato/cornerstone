 ...
 */
export function renderWebImage(enabledElement: CStone.EnabledElement, invalidated?: boolean) {

    if(enabledElement === undefined) {
        throw "drawImage: enabledElement parameter must not be undefined";
    }
    let image = <CStone.WebImage>enabledElement.image;
    if(image === undefined) {
    ...
    let context: any = enabledElement.canvas.getContext('2d');
