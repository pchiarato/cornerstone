...
function lutMatches(a: CStone.LUT, b: CStone.LUT): boolean {
...
function getLut(image: CStone.Image, viewport: CStone.Viewport, invalidated?: boolean)
{
 ...
 */
export function renderGrayscaleImage(enabledElement: CStone.EnabledElement, invalidated?: boolean) {
