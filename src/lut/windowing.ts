...
export function WindowingLutRendererWebgl(): LutRendererWebgl<WindowingLut> {
    return {
        match: WindowingLut.match,
...
export function ThresholdWindowingLutRendererWebgl(): LutRendererWebgl<ThresholdWindowingLut> {
    return {
        match: (lut: BaseLut): lut is ThresholdWindowingLut =>
            lut && (<ThresholdWindowingLut>lut).center !== undefined && (<ThresholdWindowingLut>lut).width === 1,
