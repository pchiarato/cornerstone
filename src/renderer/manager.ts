import { Injector, SkipSelf, Optional } from '@angular/core';
...
export function factory(parent: RenderersManager, injector: Injector) {
	return parent || new RenderersManager(injector);
}

export const RenderersManagerProvider = {
	provide: RenderersManager,
	deps: [[new SkipSelf(), new Optional(), RenderersManager], Injector],
	useFactory: factory
};
